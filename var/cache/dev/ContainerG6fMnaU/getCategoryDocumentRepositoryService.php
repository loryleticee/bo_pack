...
// Returns the private 'App\Repository\CategoryDocumentRepository' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoryDocumentRepository.php';

return $this->privates['App\\Repository\\CategoryDocumentRepository'] = new \App\Repository\CategoryDocumentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
