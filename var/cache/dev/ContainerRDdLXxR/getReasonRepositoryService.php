...
// Returns the private 'App\Repository\ReasonRepository' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReasonRepository.php';

return $this->privates['App\\Repository\\ReasonRepository'] = new \App\Repository\ReasonRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
