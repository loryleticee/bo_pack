...
// Returns the private 'App\Repository\CategoryUserRepository' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoryUserRepository.php';

return $this->privates['App\\Repository\\CategoryUserRepository'] = new \App\Repository\CategoryUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
