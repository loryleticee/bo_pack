...
// Returns the private 'App\Repository\CongresRepository' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CongresRepository.php';

return $this->privates['App\\Repository\\CongresRepository'] = new \App\Repository\CongresRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
