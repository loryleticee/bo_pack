...
class __TwigTemplate_9891ab8ba09b27a4b5258ca0b9e66eb9873ecc834d1ce0c3d30270dca6dcbba5 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        ...
        echo "\" class=\"cat ";
        echo (((0 === twig_compare((isset($context["route"]) || array_key_exists("route", $context) ? $context["route"] : (function () { throw new RuntimeError('Variable "route" does not exist.', 7, $this->source); })()), "admin_categorie"))) ? ("active") : (""));
...
", "admin/_navbar.html.twig", "/var/www/vhosts/evenements-incyte.com/httpdocs/templates/admin/_navbar.html.twig");
    }
}
