...
class __TwigTemplate_8c331aef9a17c038a951e426dc2fba1c1ae6b9edcc6c961ccfd27d4f257f04c3 extends Template
{
    private $source;
    private $macros = [];
...
<center style=\"width:100% !important; height:100% !important; table-layout:fixed !important; background-color:#f3f4f7;\">
    <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" style=\"margin:auto;\">
        ...
        // line 360
        echo twig_escape_filter($this->env, ($context["domain_name"] ?? null), "html", null, true);
        echo "/public/email/images/logo.png\" width=\"142\"
                    ...
                    <tr>
                        <td style=\"mso-padding-alt: 30px 45px; padding: 30px 45px;  font-size: 30px; background-color:white; mso-line-height: exactly; font-weight: 800; color: #e2574c;font-family: 'OpenSans-Bold', 'Arial', Arial, sans-serif;\"
                            align=\"center\">";
        // line 365
        echo (((0 === twig_compare(($context["refusedBy"] ?? null), "customer"))) ? ("Votre rendez-vous a été annulé") : ("Ce créneau n'est plus disponible"));
        echo "</td>
                    </tr>
                    <tr>
        ...
        // line 369
        echo twig_escape_filter($this->env, ($context["domain_name"] ?? null), "html", null, true);
        echo "/public/email/images/picto-refus.jpg\"
        ...
        // line 375
        echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, twig_get_attribute($this->env, $this->source, ($context["meeting"] ?? null), "startDate", [], "any", false, false, false, 375), "full", "none", "", null, "gregorian", "fr"), "html", null, true);
        echo "</span><br><span
                                    style=\"font-size: 20px; color: #000000; font-weight: 800; text-transform: uppercase;\">";
        // line 376
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["meeting"] ?? null), "startDate", [], "any", false, false, false, 376), "H:i"), "html", null, true);
        echo " - ";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["meeting"] ?? null), "endDate", [], "any", false, false, false, 376), "H:i"), "html", null, true);
        echo "</span>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width=\"630\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"w100p\">
                                ...
                                <tr>
                                    <td style=\"mso-padding-alt: 20px 10px; padding: 20px 10px; border-bottom: #efefef 1px solid; border-top: #efefef 1px solid;\">
                                        <span style=\"font-family:'Arial','Verdana',sans-serif;font-size: 13px; text-transform: uppercase; color: #7b7b7b\">";
        // line 407
        echo (((0 === twig_compare(($context["refusedBy"] ?? null), "customer"))) ? ("MOTIF DE L'ANNULATION") : ("MOTIF DU REFUS"));
        echo "</span>
                                        <p style=\"font-size: 15px; color: #000000;font-family: 'OpenSans-Bold', 'Arial', Arial, sans-serif;font-weight: 800;\">
                                            ";
        // line 409
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["meeting"] ?? null), "reasonCancel", [], "any", false, false, false, 409), "html", null, true);
        echo "
                                        </p></td>
                                </tr>
                                <tr>
                                    <td style=\"mso-padding-alt: 20px 10px; padding: 20px 10px; border-bottom: #efefef 1px solid;\">
                                        <span style=\"font-family:'Arial','Verdana',sans-serif;font-size: 13px; text-transform: uppercase; color: #7b7b7b\">Contact</span>
                                        <p style=\"font-size: 15px; color: #000000;font-family: 'OpenSans-Bold', 'Arial', Arial, sans-serif;font-weight: 800;\">
                                            ";
        // line 416
        if ((0 === twig_compare(($context["refusedBy"] ?? null), "customer"))) {
            // line 417
            echo "                                            ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "civility", [], "any", false, false, false, 417), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "lastname", [], "any", false, false, false, 417), "html", null, true);
            echo "<br>
                                            ";
            // line 418
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "email", [], "any", false, false, false, 418), "html", null, true);
            echo "<br>
                                            ";
            // line 419
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "localisation", [], "any", false, false, false, 419), "html", null, true);
            echo "<br>
                                            ";
            // line 420
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "phone", [], "any", false, false, false, 420), "html", null, true);
            echo "
                                            ";
        } else {
            // line 422
            echo "                                                ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["contact"] ?? null), "lastname", [], "any", false, false, false, 422), "html", null, true);
            echo "<br>
                                                ";
            // line 423
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["contact"] ?? null), "email", [], "any", false, false, false, 423), "html", null, true);
            echo "<br>
                                                ";
            // line 424
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["contact"] ?? null), "localisation", [], "any", false, false, false, 424), "html", null, true);
            echo "<br>
                                                ";
            // line 425
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["contact"] ?? null), "phone", [], "any", false, false, false, 425), "html", null, true);
            echo "
                                            ";
        }
        // line 427
                                ...
                                <tr>
                                    <td style=\"mso-padding-alt: 0px; padding: 0px;\" align=\"center\">
                                        <div>
                                            ...
                                            ";
        // line 463
        if ((0 === twig_compare(($context["refusedBy"] ?? null), "contact"))) {
            // line 464
            echo "                                                <a href=\"";
            echo twig_escape_filter($this->env, ($context["domain_name"] ?? null), "html", null, true);
            echo "/congres/";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["congres"] ?? null), "id", [], "any", false, false, false, 464), "html", null, true);
            echo "/contact?firstname=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "firstname", [], "any", false, false, false, 464), "html", null, true);
            echo "&lastname=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "lastname", [], "any", false, false, false, 464), "html", null, true);
            echo "&mail=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "email", [], "any", false, false, false, 464), "html", null, true);
            echo "&phone=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "phone", [], "any", false, false, false, 464), "html", null, true);
            echo "&civility=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "civility", [], "any", false, false, false, 464), "html", null, true);
            echo "&localisation=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer"] ?? null), "localisation", [], "any", false, false, false, 464), "html", null, true);
            echo "&reason=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["meeting"] ?? null), "reason", [], "any", false, false, false, 464), "id", [], "any", false, false, false, 464), "html", null, true);
            echo "&contact=";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["contact"] ?? null), "id", [], "any", false, false, false, 464), "html", null, true);
            echo "\"
            ...
            echo "/";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["congres"] ?? null), "id", [], "any", false, false, false, 471), "html", null, true);
            echo "\"
                                                   style=\"font-family:'Arial','Verdana',sans-serif;background-color:#285eb4;color:#ffffff;display:inline-block;font-size:19px;font-weight:bold;height:50px;line-height:50px;mso-line-height:45px;text-align:center;text-decoration:none;width:445px;-webkit-text-size-adjust:none;border-radius: 50px;\"
                                                   class=\"but w100p\"
                                                >
        ...
        echo "                                            <!--[if mso]></center></v:roundrect><![endif]-->
                    ...
                    <tr>
                        <td style=\"mso-padding-alt:20px; padding:20px;font-family:'Arial','Verdana',sans-serif;font-size: 11px;color: #303030;background-color: #f3f4f7;\"
                            align=\"left\">
                            ";
        // line 492
        if ((0 === twig_compare(($context["refusedBy"] ?? null), "customer"))) {
    ...
    {
        return array (  667 => 526,  632 => 493,  630 => 492,  614 => 478,  599 => 471,  570 => 464,  568 => 463,  530 => 427,  525 => 425,  521 => 424,  517 => 423,  512 => 422,  507 => 420,  503 => 419,  499 => 418,  492 => 417,  490 => 416,  480 => 409,  475 => 407,  463 => 397,  453 => 389,  445 => 383,  443 => 382,  432 => 376,  428 => 375,  419 => 369,  412 => 365,  404 => 360,  71 => 30,  61 => 23,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "emails/annulationMeeting.html.twig", "/var/www/vhosts/evenements-incyte.com/httpdocs/templates/emails/annulationMeeting.html.twig");
    }
}
