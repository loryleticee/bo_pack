...
class getAdminControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\admin\\AdminController'] = $instance = new \App\Controller\admin\AdminController(($container->privates['App\\Manager\\CongresManager'] ?? $container->load('getCongresManagerService')), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')), ($container->privates['App\\Manager\\CategoriesManager'] ?? $container->load('getCategoriesManagerService')));
